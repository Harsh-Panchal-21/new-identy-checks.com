...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <telerik:RadAjaxPanel ID="rapOne" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
    <table cellpadding="2" cellspacing="0" border="1" style="font-size: 8pt; width: 775px;">
      ...
      <tr>
        <td>
          <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="true" AutoGenerateColumns="false" Visible="false">
            <MasterTableView AllowFilteringByColumn="true">
              <Columns>
                <telerik:GridBoundColumn HeaderText="Org Name Ind Name" DataField="Name" DataType="System.String"  
								    UniqueName="Name2" SortExpression="Name" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
              </Columns>
            </MasterTableView>
          </telerik:RadGrid>
          ...
          <telerik:radgrid id="rgFS" runat="server" GridLines="None" AutoGenerateColumns="False" AllowSorting="True"
					    ...
					    <MasterTableView DataKeyNames="Doc,id" AllowPaging="True" AllowFilteringByColumn="true" GridLines="None">
						    <PagerStyle  Position="TopAndBottom" Mode="NumericPages"></PagerStyle>
						    <Columns>
                  <telerik:GridBoundColumn HeaderText="Submitted" AutoPostBackOnFilter="false"
								    DataField="date_submitted" UniqueName="date_submitted" SortExpression="date_submitted"></telerik:GridBoundColumn>
							    <telerik:GridBoundColumn HeaderText="Type" AutoPostBackOnFilter="false"
								    DataField="Doc" UniqueName="Doc" SortExpression="Doc"></telerik:GridBoundColumn>
							    <telerik:GridBoundColumn HeaderText="Org Name/Ind Name" DataField="Name" DataType="System.String"  
								    UniqueName="Name" SortExpression="Name" AutoPostBackOnFilter="false"></telerik:GridBoundColumn>
