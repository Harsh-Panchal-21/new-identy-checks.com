...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <table cellpadding="2" cellspacing="0" border="1" style="font-size: 8pt; width: 575px;">
      ...
      <tr>
        <td>Corp State: <asp:Label ID="lblCorpState" runat="server" Font-Bold="true"></asp:Label></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>
          XML Doc Receipt ID: <asp:label ID="lblDocReceiptID" runat="server" Font-Bold="true"></asp:label>
      ...
      <tr>
        <td>Packet Num: <asp:label ID="lblPacketNum" runat="server" Font-Bold="true"></asp:label></td>
      </tr>
      <tr>
