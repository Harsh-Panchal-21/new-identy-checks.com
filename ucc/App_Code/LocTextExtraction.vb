...
Namespace LocTextExtraction
  ...
  Public Class LocTextExtractionStrategy
    ...
    Public locationalResult As New List(Of TextChunk)()
    ...
    Private Function GetRectangleFromText(ByVal FirstChunk As TextChunk, ByVal LastChunk As TextChunk, ByVal pSearchString As String, _
      ...
      Dim LineTextWidth As Single = GetStringWidth(sTextinChunks, LastChunk.curFontSize, LastChunk.charSpaceWidth, _
      ...
      If iStart > 0 Then
        LeftWidth = GetStringWidth(sLeft, LastChunk.curFontSize, LastChunk.charSpaceWidth, _
                                          ThisPdfDocFonts.Values.ElementAt(LastChunk.FontIndex))
      ...
      If iEnd < sTextinChunks.Length - 1 Then
        RightWidth = GetStringWidth(sRight, LastChunk.curFontSize, LastChunk.charSpaceWidth, _
            ThisPdfDocFonts.Values.ElementAt(LastChunk.FontIndex))
