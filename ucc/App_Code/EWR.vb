...
Public Module EWR
  ...
  Public UCCXML_StatusRequestURL_Prod As String = ConfigurationManager.AppSettings("UCCXML_StatusRequestURL_Prod")
	Public UCCXML_RetrieveDocURL_Prod As String = ConfigurationManager.AppSettings("UCCXML_RetrieveDocURL_Prod")
	Public UCCXML_Acct_Num_WI As String = ConfigurationManager.AppSettings("UCCXML_Acct_Num_WI")
	Public UCCXML_UserID_WI As String = ConfigurationManager.AppSettings("UCCXML_UserID_WI")
	Public UCCXML_Password_WI As String = ConfigurationManager.AppSettings("UCCXML_Password_WI")
	Public FILINGS_PATH As String = ConfigurationManager.AppSettings("FILINGS_PATH")
  ...
  End Function
	...
	Public Sub FillDebtorInfo(ByVal sDebtorID As String, ByVal sComID As String, ByVal sParentComID As String, ByRef txtOrgName As TextBox, ByRef txtLastName As TextBox,
														ByRef txtFirstName As TextBox, ByRef txtMiddleName As TextBox, ByRef txtSuffix As TextBox,
														ByRef txtMailingAddress As TextBox, ByRef txtCity As TextBox, ByRef lstState As DropDownList,
														ByRef txtZip As TextBox, ByRef txtCountry As TextBox, ByRef txtD1 As TextBox,
														ByRef txtOrgType As TextBox, ByRef txtOrgJurisdiction As TextBox, ByRef txtOrgID As TextBox,
														ByRef chkOrgIDNone As CheckBox)
		Try
			If sParentComID = "" Then sParentComID = "-1"

			Dim dtDebtor As DataTable = FillDataTable("Select * From ucc_debtor where ud_id = " & sDebtorID & " and " &
					" ud_company_id in (Select company_id from subscriber where ucc_app = 'Y' and (company_id = " & sComID & " or parent_company_id = " & sParentComID & " or parent_company_id = " & sComID & "))")
  ...
  End Function
	...
	Public Function EnterSearch(ByVal us_debtor As String, ByVal us_sr_certified As String, ByVal us_sr As String,
					ByVal us_cr_certified As String, ByVal us_cr As String, ByVal us_sco_certified As String,
					ByVal us_more_date As String, ByVal us_more_address As String, ByVal us_more_name As String, ByVal us_more_other As String,
					ByVal us_sco1_rec_no As String, ByVal us_sco1_date As String, ByVal us_sco1_type As String,
					ByVal us_sco2_rec_no As String, ByVal us_sco2_date As String, ByVal us_sco2_type As String,
					ByVal us_sco3_rec_no As String, ByVal us_sco3_date As String, ByVal us_sco3_type As String,
					ByVal us_sco4_rec_no As String, ByVal us_sco4_date As String, ByVal us_sco4_type As String,
					ByVal us_sco5_rec_no As String, ByVal us_sco5_date As String, ByVal us_sco5_type As String,
					ByVal us_sco6_rec_no As String, ByVal us_sco6_date As String, ByVal us_sco6_type As String,
					ByVal us_additional As String, ByVal us_status As String, ByVal us_user_submitted As String,
					ByVal sComID As String, ByVal us_charge As String, ByVal us_loan_type As String, ByVal us_fsfl_fy As String, ByVal us_corp_state As String) As String
		Dim sSQL As String = ""
		Dim sUS_ID As String = ""

		sSQL = "Insert Into ucc_search (us_debtor,us_sr_certified,us_sr,us_cr_certified,us_cr,us_sco_certified," &
			"us_more_date,us_more_address,us_loan_type,us_fsfl_fy,us_more_name,us_more_other," &
			"us_sco1_rec_no,us_sco1_date,us_sco1_type,us_sco2_rec_no,us_sco2_date,us_sco2_type,us_sco3_rec_no,us_sco3_date," &
			"us_sco3_type,us_sco4_rec_no,us_sco4_date,us_sco4_type,us_sco5_rec_no,us_sco5_date,us_sco5_type,us_sco6_rec_no," &
			"us_sco6_date,us_sco6_type,us_additional,us_status,us_date_submitted,us_user_submitted,us_company_id,us_charge,us_corp_state) values (" & us_debtor & "," &
			"'" & us_sr_certified.Replace("'", "''") & "', " &
			"'" & us_sr.Replace("'", "''") & "', " &
			"'" & us_cr_certified.Replace("'", "''") & "', " &
			"'" & us_cr.Replace("'", "''") & "', " &
			"'" & us_sco_certified.Replace("'", "''") & "', " &
			"'" & us_more_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_more_address.Replace("'", "''").ToUpper & "', " &
			"'" & us_loan_type & "', " &
			"" & us_fsfl_fy & ", " &
			"'" & us_more_name.Replace("'", "''").ToUpper & "', " &
			"'" & us_more_other.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco1_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco1_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco1_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco2_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco2_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco2_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco3_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco3_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco3_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco4_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco4_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco4_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco5_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco5_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco5_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco6_rec_no.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco6_date.Replace("'", "''").ToUpper & "', " &
			"'" & us_sco6_type.Replace("'", "''").ToUpper & "', " &
			"'" & us_additional.Replace("'", "''").ToUpper & "', " &
			"'N', getdate(),'" & us_user_submitted.Replace("'", "''") & "'," & sComID & "," &
			IIf(us_charge <> "", us_charge, "Null") & ",'" & us_corp_state & "'); Select Scope_Identity()"
    ...
    If sHasCompanies = "Y" Then
			sWhereCom = " in (Select company_id from subscriber where company_id = " & sComID & " or parent_company_id = " & sComID & ") "
		Else
      sWhereCom = " = " & sComID & " "
    End If
  ...
  Public Sub AddTiff(pdfDocument As Document, tiffPath As [String])
