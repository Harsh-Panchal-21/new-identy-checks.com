    ...
    <table cellpadding="2" cellspacing="0" border="1" style="font-size: 8pt; width: 800px;">
      ...
      <tr>
        ...
        <td align="left">
          ...
          <asp:CheckBox ID="chkSR_All" runat="server" Text="All (Check this box to request a response that is complete, including filings that have lapsed.)" />
          <asp:CheckBox ID="chkSR_Unlapsed" runat="server" Text="Unlapsed" Checked="true" />
        </td>
      </tr>
      <tr>
        <td align="left" valign="top" colspan="2">
