  ...
  Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    If Not Page.IsPostBack Then
      ...
      Dim sFrom As String, sFile As String, sIDField As String, sDebtor As String, sComID As String, sStatusReason As String
			Dim sFileNo As String, sFileDate As String, sFileStatus As String, sCharge As String, sDocReceiptID As String, sPacketNum As String, sCorpStateField As String
        ...
        Case "UCC1"
          ...
          sCharge = "uf_charge"
					...
					sPacketNum = "uf_packet_num"
					sComID = "uf_company_id"
					sStatusReason = "uf_status_reason"
					sCorpStateField = "uf_corp_state"
        ...
        Case "UCC3"
          ...
          sCharge = "u3_charge"
					...
					sPacketNum = "u3_packet_num"
					sComID = "u3_company_id"
					sStatusReason = "u3_status_reason"
					sCorpStateField = "u3_corp_state"
      ...
      If dtData.Rows.Count > 0 Then
        With dtData.Rows(0)
          ...
          txtCharge.Text = .Item(sCharge) & ""
					...
					lblPacketNum.Text = .Item(sPacketNum) & ""
					lblCorpState.Text = .Item(sCorpStateField) & ""
  ...
  Protected Sub btnSubmitXML_Click(sender As Object, e As System.EventArgs) Handles btnSubmitXML.Click
    ...
    If sResult = "" Then
      Select Case Request.QueryString("type") & ""
        Case "UCC1"
          ...
          sFileStatus = "uf_status"
					...
					Select Case lblCorpState.Text.Trim()
						Case "IL", ""
							sResult = sosxml.Submit_Filing(sID, sDocReceiptID, sPacketNum)
						Case "WI"
							sResult = sosxml.Submit_FilingWI(sID, sDocReceiptID, sPacketNum)
						Case Else
							sResult = sosxml.Submit_Filing(sID, sDocReceiptID, sPacketNum)
					End Select
          ...
          sFileStatus = "u3_status"
					...
					Select Case lblCorpState.Text.Trim()
						...
						Case "WI"
							sResult = sosxml.Submit_AmendmentWI(sID, sDocReceiptID, sPacketNum)
						Case Else
							sResult = sosxml.Submit_Amendment(sID, sDocReceiptID, sPacketNum)
					End Select
      ...
      If sResult = "" Then
				...
				Try
					lstStatus.SelectedIndex = -1
					lstStatus.Items.FindByValue("S").Selected = True
				Catch ex As Exception
  ...
  Protected Sub btnCheckStatus_Click(sender As Object, e As EventArgs) Handles btnCheckStatus.Click
    Dim sRtn As String = ""
		...
		Select Case lblCorpState.Text.Trim()
			...
			Case "WI"
				sRtn = sosxml.StatusRequestWI(lblDocReceiptID.Text)
			Case Else
				sRtn = sosxml.StatusRequest(lblDocReceiptID.Text)
		End Select
