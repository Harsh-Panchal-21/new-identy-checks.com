...
Partial Class ucc1
    ...
    If Not Page.IsPostBack Then
      ...
      lstOrg_State.DataValueField = "STATE_ABBR"
        ...
        lstDebtor1_State.SelectedIndex = -1
				lstDebtor1_State.Items.FindByValue(sState).Selected = True
      ...
      Try
        lstDebtor2_State.SelectedIndex = -1
				lstDebtor2_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor3_State.SelectedIndex = -1
				lstDebtor3_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor4_State.SelectedIndex = -1
				lstDebtor4_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor5_State.SelectedIndex = -1
				lstDebtor5_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor6_State.SelectedIndex = -1
				lstDebtor6_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstSecured_State.SelectedIndex = -1
				lstSecured_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstSecured2_State.SelectedIndex = -1
				lstSecured2_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstSecured3_State.SelectedIndex = -1
				lstSecured3_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstSecured4_State.SelectedIndex = -1
				lstSecured4_State.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor1_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor1_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor2_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor2_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor3_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor3_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor4_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor4_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor5_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor5_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      Try
        lstDebtor6_Org_Jurisdiction.SelectedIndex = -1
				lstDebtor6_Org_Jurisdiction.Items.FindByValue(sState).Selected = True
			Catch ex As Exception
      ...
      End Try
			...
			If dtComp.Rows.Count > 0 and sState <> "IL" Then
				lstSecured_Org_Name.Items.Add(New ListItem("CCC c/o " & dtComp.Rows(0).Item("name"), "CCC c/o " & dtComp.Rows(0).Item("name")))
  ...
  End Function
	...
	Private Shared Function GetData(ByVal text As String, ByVal sFrom As String, ByVal sCompanyID As String, ByVal sParentCompanyID As String) As DataTable
		If sParentCompanyID = "" Then sParentCompanyID = "-1"
  ...
  Protected Sub rcbDebtor3_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles rcbDebtor3.SelectedIndexChanged
    ...
    'tmpTextA.Text = lstDebtor3_Org_Type.SelectedValue
		...
		If rcbDebtor3.SelectedValue Is Nothing OrElse rcbDebtor3.SelectedValue = "" Then Exit Sub
		FillDebtorInfo(rcbDebtor3.SelectedValue, Session("company_rid") & "", Session("parent_company_id") & "", txtDebtor3_Org_Name, txtDebtor3_Ind_Last_Name, txtDebtor3_Ind_First_Name, txtDebtor3_Ind_Middle_Name, txtDebtor3_Ind_Suffix, txtDebtor3_Mailing_Address, txtDebtor3_City, lstDebtor3_State, txtDebtor3_Zip, txtDebtor3_Country, txtDebtor3_d1, tmpTextA, tmpTextB, txtDebtor3_Org_ID, chkDebtor3_Org_ID_None)
	End Sub
  ...
  Protected Sub rcbDebtor5_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles rcbDebtor5.SelectedIndexChanged
    ...
    'tmpTextA.Text = lstDebtor5_Org_Type.SelectedValue
		...
		If rcbDebtor5.SelectedValue Is Nothing OrElse rcbDebtor5.SelectedValue = "" Then Exit Sub
		FillDebtorInfo(rcbDebtor5.SelectedValue, Session("company_rid") & "", Session("parent_company_id") & "", txtDebtor5_Org_Name, txtDebtor5_Ind_Last_Name, txtDebtor5_Ind_First_Name, txtDebtor5_Ind_Middle_Name, txtDebtor5_Ind_Suffix, txtDebtor5_Mailing_Address, txtDebtor5_City, lstDebtor5_State, txtDebtor5_Zip, txtDebtor5_Country, txtDebtor5_d1, tmpTextA, tmpTextB, txtDebtor5_Org_ID, chkDebtor5_Org_ID_None)
	End Sub
  ...
  Protected Sub rcbDebtor6_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles rcbDebtor6.SelectedIndexChanged
    ...
    'tmpTextA.Text = lstDebtor6_Org_Type.SelectedValue
		...
		If rcbDebtor6.SelectedValue Is Nothing OrElse rcbDebtor6.SelectedValue = "" Then Exit Sub
		FillDebtorInfo(rcbDebtor6.SelectedValue, Session("company_rid") & "", Session("parent_company_id") & "", txtDebtor6_Org_Name, txtDebtor6_Ind_Last_Name, txtDebtor6_Ind_First_Name, txtDebtor6_Ind_Middle_Name, txtDebtor6_Ind_Suffix, txtDebtor6_Mailing_Address, txtDebtor6_City, lstDebtor6_State, txtDebtor6_Zip, txtDebtor6_Country, txtDebtor6_d1, tmpTextA, tmpTextB, txtDebtor6_Org_ID, chkDebtor6_Org_ID_None)
	End Sub
  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    Try
      ...
      If chkDebtor1_RunSearch.Checked Then
        ...
        Dim sMoreOther As String = txtMoreOther1.Text
				Dim sUS_ID As String = EnterSearch(sDebtor1, "", sSR1, "", sCR1, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional1.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue, ddlFY.SelectedValue, ckState)
			End If
      ...
      If chkDebtor2_RunSearch.Checked Then
        ...
        Dim sMoreOther As String = txtMoreOther2.Text
				Dim sUS_ID As String = EnterSearch(sDebtor2, "", sSR2, "", sCR2, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional2.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue, ddlFY.SelectedValue, ckState)
			End If
    Catch ex As Exception
    ...
    Try
			sSQL = "Insert Into ucc_financing (uf_debtor1,uf_debtor2,uf_secured_org_name,uf_secured_mailing_address," &
			"uf_secured_city,uf_secured_state,uf_secured_zipcode,uf_secured_country,uf_finance_statement,uf_alt_designation," &
			"uf_file_real_estate,uf_request_search,uf_loan_type,uf_fsfl_fy,uf_reference_data,uf_date_submitted,uf_user_submitted,uf_charge,uf_company_id,uf_corp_state) Values (" &
			sDebtor1 & "," & IIf(sDebtor2 <> "", sDebtor2, "Null") & "," &
			"'" & lstSecured_Org_Name.SelectedValue.Replace("'", "''").ToUpper & "', " &
			"'" & txtSecured_Mailing_Address.Text.Replace("'", "''").ToUpper & "', " &
			"'" & txtSecured_City.Text.Replace("'", "''").ToUpper & "', " &
			"'" & lstSecured_State.SelectedValue.Replace("'", "''").ToUpper & "', " &
			"'" & txtSecured_Zip.Text.Replace("'", "''").ToUpper & "', " &
			"'" & txtSecured_Country.Text.Replace("'", "''").ToUpper & "', " &
			"'" & txtCollateral.Text.Replace("'", "''").ToUpper & "', " &
			"'" & sAltDes & "', " &
			"'" & IIf(chkReal_Estate.Checked, "Y", "N") & "', " &
			"'" & sReqSearch & "', " &
			"'" & ddlLoanType.SelectedValue & "', " &
			"" & ddlFY.SelectedValue & ", " &
			"'" & txtReference_Data.Text.Replace("'", "''").ToUpper & "',getdate(),'" & Session("UserID") & "'," &
			IIf(Filing_Charge <> "", Filing_Charge, "Null") & "," & Session("company_rid") & ",'" & ckState & "'" &
      ...
      Try
        ...
        If chkDebtor3_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName3.Text
					...
					Dim sUS_ID As String = EnterSearch(sDebtor3, "", sSR3, "", sCR3, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional3.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue, ckState)
				End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor4_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName4.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
					Dim sUS_ID As String = EnterSearch(sDebtor4, "", sSR4, "", sCR4, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional4.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue, ckState)
				End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor5_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName5.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
					Dim sUS_ID As String = EnterSearch(sDebtor5, "", sSR5, "", sCR5, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional5.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue, ckState)
				End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor6_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName6.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
					Dim sUS_ID As String = EnterSearch(sDebtor6, "", sSR6, "", sCR6, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional6.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue, ckState)
				End If
      Catch ex As Exception
    ...
    End If
		...
		SendEmailNew(0, 0, "A new UCC Financing Filing has been submitted for " & ckState & ".", "New UCC UCC Financing Filing submitted for " & ckState, IDC_Notify, "", True)
