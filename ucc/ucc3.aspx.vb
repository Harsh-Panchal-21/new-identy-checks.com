    ...
    If Not Page.IsPostBack Then
      ...
      lstSecured3_State.DataBind()
			...
			If dtComp.Rows.Count > 0 and sState <> "IL" Then
				lstSecured_Org_Name.Items.Add(New ListItem("CCC C/O " & UCase(dtComp.Rows(0).Item("name")), "CCC C/O " & UCase(dtComp.Rows(0).Item("name"))))
			End If
			dtComp.Dispose()
			dtComp = Nothing
			...
			lstSecured2_Org_Name.DataBind()
				...
				If dtUF.Rows.Count > 0 Then
					'lstOrg_State.SelectedValue
					Try
						lstOrg_State.SelectedIndex = -1
						lstOrg_State.Items.FindByValue(dtUF.Rows(0).Item("uf_corp_state") & "").Selected = True
					Catch ex As Exception
  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    Try
      ...
      dtComp = Nothing
			...
			sSQL = "Insert Into ucc3 (u3_uf_id,u3_initial_file_no,u3_real_estate,u3_loan_type,u3_initial_name,u3_fsfl_fy,u3_termination,u3_continuation,u3_assignment,u3_amendment_affects," &
				"u3_amendment,u3_old_org_name,u3_old_ind_last_name,u3_old_ind_first_name,u3_old_ind_middle_name,u3_old_ind_suffix ," &
				"u3_new_debtor,u3_collateral_change,u3_collateral,u3_secured_org_name, " &
				"u3_secured_mailing_address, u3_secured_city, u3_secured_state, u3_secured_zipcode, u3_secured_country, " &
				"u3_reference_data,u3_date_submitted,u3_user_submitted, " &
				"u3_status,u3_charge,u3_company_id,u3_corp_state) Values (" &
				sUF_ID & ",'" & txtInitial_file_No.Text.Replace("'", "''").ToUpper & "'," &
				"'" & IIf(chkReal_Estate.Checked, "Y", "N") & "', " &
				"'" & ddlLoanType.SelectedValue & "', " &
				"'" & txtInitialName.Text.Replace("'", "''").ToUpper & "'," &
				"" & ddlFY.SelectedValue & ", " &
				"'" & IIf(chkTermination.Checked, "Y", "N") & "', " &
				"'" & IIf(chkContinuation.Checked, "Y", "N") & "', " &
				"'" & IIf(chkAssignment.Checked, "Y", "N") & "', " &
				"'" & IIf(chkAmend_Debtor.Checked, "D", IIf(chkAmend_Secured_Party.Checked, "S", "")) & "', " &
				"'" & IIf(chkAmend_Change.Checked, "C", IIf(chkAmend_Delete.Checked, "D", IIf(chkAmend_Add.Checked, "A", ""))) & "', " &
				"'" & txtOrig_Org_Name.Text.Replace("'", "''").ToUpper & "', " &
				"'" & txtOrig_Ind_Last_Name.Text.Replace("'", "''").ToUpper & "', " &
				"'" & txtOrig_Ind_First_Name.Text.Replace("'", "''").ToUpper & "', " &
				"'" & txtOrig_Ind_Middle_Name.Text.Replace("'", "''").ToUpper & "', " &
				"'" & txtOrig_Ind_Suffix.Text.Replace("'", "''").ToUpper & "', " &
				sNew_Debtor & "," &
				"'" & IIf(chkCollateral_Deleted.Checked, "D", IIf(chkCollateral_Added.Checked, "A", IIf(chkCollateral_Restated.Checked, "R", IIf(chkCollateral_Assigned.Checked, "S", "")))) & "', " &
				"'" & txtCollateral.Text.Replace("'", "''").ToUpper & "', " &
				"'" & lstSecured_Org_Name.SelectedValue.Replace("'", "''").ToUpper & "', " &
				"'" & sSecMailAddress & "','" & sSecCity & "','" & sSecZip & "','" & sSecCountry & "','" & sSecState & "', " &
				"'" & txtReference_Data.Text.Replace("'", "''").ToUpper & "',getdate(),'" & Session("UserID") & "','N'," &
				IIf(Filing_Charge_Amendment <> "", Filing_Charge_Amendment, "Null") & "," & Session("company_rid") & ",'" & ckState & "'" &
        ...
        Try
          ...
          If chkDebtor3_RunSearch.Checked Then
            ...
            Dim sMoreOther As String = txtMoreOther3.Text
						Dim sUS_ID As String = EnterSearch(sDebtor3, "", sSR3, "", sCR3, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional3.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue, ddlFY.SelectedValue, ckState)
					End If
        Catch ex As Exception
        ...
        Try
          ...
          If chkDebtor4_RunSearch.Checked Then
            ...
            Dim sMoreOther As String = txtMoreOther4.Text
						Dim sUS_ID As String = EnterSearch(sDebtor4, "", sSR4, "", sCR4, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional4.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue, ddlFY.SelectedValue, ckState)
					End If
        Catch ex As Exception
