...
Partial Class admin_reports
  ...
  Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    If Not Page.IsPostBack Then
      ...
      rdpToDate.SelectedDate = New Date(Now.Year, Now.Month, 1).AddMonths(1).AddDays(-1)
			...
			'lstCompanies
			Dim sSQL As String = "Select name, company_id from subscriber where ucc_app = 'Y' and parent_company_id is null"
			Dim dtUCC As DataTable = FillDataTable(sSQL)
			lstCompanies.DataSource = dtUCC
  ...
  Protected Sub rgCharge_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rgCharge.NeedDataSource
    If Not e.IsFromDetailTable Then
			...
			Dim sCom As String = lstCompanies.SelectedValue & ""

			'If Session("has_sub_companies") = "Y" Then
			sWhereCom = " in (Select company_id from subscriber where ucc_app = 'Y' and (company_id = " & sCom & " or parent_company_id = " & sCom & ")) "
			'Else
  ...
  End Sub
	...
	Protected Sub btnSearch_Click(sender As Object, e As System.EventArgs) Handles btnSearch.Click
		If lstCompanies.SelectedValue & "" <> "" Then
			rgCharge.Rebind()
			rgSum.Rebind()
		Else
