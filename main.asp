...
SQL = SQL & "left join SelfServeCandidate on candidate.company_id = SelfServeCandidate.companyID and candidate.id = selfServeCandidate.candidateID "
...
SQL = SQL & " and ISNULL(SelfServeCandidate.hasEntered,1) = 1"
...
SQL1 = "Select * From SelfServeCandidate where hasEntered = 0 and deleted = 0 and companyID = " & company_id
SQL1 = SQL1 & " ORDER BY selfServeCandidateId" 
Set conn1 = GetSQLServerConnection( db_machine, db_userid, db_password, db_database ) 
Set rs1 = GetSQLServerStaticRecordset( conn1, SQL1 )
%>
            	...
            	<tr>
                    ...
                    <center>
						...
						<a class="linkBtn" href="pdf/AuthorizationCandidateform.docx" target="_blank">Authorization for Release of Information</a>
                            ...
                            <A href="SelfServeCandidate.asp?company_id=<%=company_id%>">Request Candidate</A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h4 align="left">Candidate List</h4>
                        ...
                        If not rs1.EOF then   
                            ...
                            Response.Write " <h4 align='left'>Requested Candidates (Emailed, not filled out by candidate)</h4><br>"
                        ...
                        Response.WRITE "<Th>Signed Auth.</th>" 
                        Response.WRITE "<Th>Delete</th>" 
						Response.WRITE "<Th>Resend</th>"
                        Response.Write "</TR>"
                        ...
                        Response.Write "<TD>" & RecNo1 & ".</TD>"
                        Response.WRITE "<TD>" & rs1("ssFname") & " " & rs1("ssLname") & "</TD>"
                        Response.WRITE "<TD>" & rs1("ssEmail") & "</TD>"
						Response.WRITE "<TD>" & rs1("ssPhone") & "</TD>"
                        Response.WRITE "<TD>" 
                            if rs1("hasAuthorized") = 0 then 
                            response.Write "No"
                            else
                            response.write "yes"
                            end if
                            ...
                            Response.Write "</TD>"
                        Response.WRITE "<TD>" & "<a HREF=delete_selfserve.asp?company_id=" & rs1("companyID") & "&id=" & rs1("selfServeCandidateId") & ">" & "<font color=red>Delete ID:" & rs1("selfServeCandidateId") & "</font>" & "</TD>"
						Response.WRITE "<TD>" & "<a HREF=SelfServeResend.asp?company_id=" & rs1("companyID") & "&id=" & rs1("candidateID") & ">" & "<font color=red>Resend ID:" & rs1("selfServeCandidateId") & "</font>" & "</TD>"
                        rs1.MoveNext
