...
SQL2 = SQL2 & "where company_id=" & company_id & " and date1 like '" & sDate & "/%/" & thisYear & "%' and hide <> 'Y' and ISNULL(SelfServeCandidate.hasEntered,1) = 1 "  '& " and hide <> 'Y'" 'finished = 'Y'
