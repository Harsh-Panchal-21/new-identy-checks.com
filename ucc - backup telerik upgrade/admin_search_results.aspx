    ...
    <table cellpadding="2" cellspacing="0" border="1" style="font-size: 8pt; width: 575px;">
      ...
      <tr>
        <td colspan="8">
          ...
          <asp:DataGrid ID="dgFiling" runat="server" AutoGenerateColumns="false" DataKeyField="ur_filing_number" CellPadding="2" CellSpacing="2">
            <Columns>
              <asp:HyperLinkColumn DataNavigateUrlFormatString="View_File.aspx?type=UCC11_results&id={0}&com={1}" DataNavigateUrlField="ur_filing_number,us_company_id" DataTextField="ur_filing_number" HeaderText="View File" Target="_blank"></asp:HyperLinkColumn>
              <asp:BoundColumn DataField="ur_filing_date" headertext="Filing Date"></asp:BoundColumn>
