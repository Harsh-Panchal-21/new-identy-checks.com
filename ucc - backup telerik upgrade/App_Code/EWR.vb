...
Public Module EWR
  ...
  Public Function EnterSearch(ByVal us_debtor As String, ByVal us_sr_certified As String, ByVal us_sr As String, _
          ...
          ByVal sComID As String, ByVal us_charge As String, ByVal us_loan_type As String, ByVal us_fsfl_fy As String) As String
    Dim sSQL As String = ""
    Dim sUS_ID As String = ""

    sSQL = "Insert Into ucc_search (us_debtor,us_sr_certified,us_sr,us_cr_certified,us_cr,us_sco_certified," & _
      "us_more_date,us_more_address,us_loan_type,us_fsfl_fy,us_more_name,us_more_other," & _
