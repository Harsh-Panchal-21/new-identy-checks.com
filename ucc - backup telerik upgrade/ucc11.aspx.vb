...
Partial Class ucc11
  ...
  Protected Sub rcbDebtor1_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles rcbDebtor1.SelectedIndexChanged
    ...
    FillDebtorInfo(rcbDebtor1.SelectedValue, Session("company_rid"), txtDebtor1_Org_Name, txtDebtor1_Ind_Last_Name, txtDebtor1_Ind_First_Name, txtDebtor1_Ind_Middle_Name, txtDebtor1_Ind_Suffix, txt1, txt2, lst1, txt4, txt5, txt6, txt7, txt8, txt9, chk1)
  End Sub
  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    Try
      Dim sUS_ID As String = EnterSearch(sDebtor1, "", sSR, "", sCR, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, sRec1, sDate1, sType1, sRec2, sDate2, sType2, sRec3, sDate3, sType3, sRec4, sDate4, sType4, sRec5, sDate5, sType5, sRec6, sDate6, sType6, txtAdditional.Text.Replace("'", "''"), "N", Session("UserID"), Session("company_rid"), Search_Charge, us_loan_type, us_fsfl_fy)
    Catch ex As Exception
      lblMsg.Text = "<br />Debtor added, but there was an error submitting the search. - " & ex.ToString
      Exit Sub
    End Try

    SendEmailNew(0, 0, "A new UCC Search has been submitted.", "New UCC Search submitted", IDC_Notify, "", True)
