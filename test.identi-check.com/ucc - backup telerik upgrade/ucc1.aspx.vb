  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    Try
      ...
      If chkDebtor1_RunSearch.Checked Then
        ...
        Dim sUS_ID As String = EnterSearch(sDebtor1, "", sSR1, "", sCR1, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional1.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue, ddlFY.SelectedValue)
      End If
    ...
    Try
      ...
      "uf_file_real_estate,uf_request_search,uf_loan_type,uf_fsfl_fy,uf_reference_data,uf_date_submitted,uf_user_submitted,uf_charge,uf_company_id) Values (" & _
    ...
    If pnlUCC1ad.Visible Then
      Try
        ...
        If chkDebtor3_RunSearch.Checked Then
          ...
          Dim sUS_ID As String = EnterSearch(sDebtor3, "", sSR3, "", sCR3, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional3.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue)
        End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor4_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName4.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
          Dim sUS_ID As String = EnterSearch(sDebtor4, "", sSR4, "", sCR4, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional4.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue)
        End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor5_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName5.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
          Dim sUS_ID As String = EnterSearch(sDebtor5, "", sSR5, "", sCR5, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional5.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue)
        End If
      Catch ex As Exception
      ...
      Try
        ...
        If chkDebtor6_RunSearch.Checked Then
          ...
          Dim sMoreName As String = txtMoreName6.Text
                    ...
                    Dim loan_type As String = ddlLoanType.SelectedValue
          Dim sUS_ID As String = EnterSearch(sDebtor6, "", sSR6, "", sCR6, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional6.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, loan_type, ddlFY.SelectedValue)
        End If
      Catch ex As Exception
