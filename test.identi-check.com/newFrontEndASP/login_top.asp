                                ...
                                <td width="100%">
                                    ...
                                    <div id="login-middle">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                            <input id="UserID" name="UserID" type="text" value="<%=UserID%>" size="20" style="background:#ffffff" autocomplete="off" />
                                            </td>
                                        </tr>    
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                            <input name="Password" type="password" size="20" style="background:#ffffff"  autocomplete="off" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
