					...
					<tr>
                        ...
                        <br />
                            ...
                            If not rs.EOF then   
                                ...
                                If Page > 1 Then
                                    Response.write "<a href='admin1.asp?by=" & sort_by & "&dir=" & sort_dir & "&page=" & (Page - 1) & strQS & "'>&lt;&lt; Previous Page</a>"
                                End If
                                Response.write "&nbsp;&nbsp;"
                                If Page < intPageCount Then
                                    Response.write "<a href='admin1.asp?by=" & sort_by & "&dir=" & sort_dir & "&page=" & (Page + 1) & strQS & "'>Next Page &gt;&gt;</a>"
                                End If	
                                
                                Response.Write "<CENTER><TABLE id='table_reg'>"
                                Response.Write "<TR>"
                                Response.Write "<TH>#</TH>"
                                Response.WRITE "<TH><a style='color: white;' href='admin1.asp?by=company&dir=" & iif(sort_by = "company" and sort_dir = "asc","desc","asc") & strQS & "'>Company</a></TH>"
                                Response.WRITE "<TH><a style='color: white;' href='admin1.asp?by=lname,fname&dir=" & iif(sort_by = "lname,fname" and sort_dir = "asc","desc","asc") & strQS & "'>Name</a></TH>"
                                Response.WRITE "<TH><a style='color: white;' href='admin1.asp?by=date1&dir=" & iif(sort_by = "date1" and sort_dir = "asc","desc","asc") & strQS & "'>Date</a></TH>" 
                                ...
                                For iPage = 1 To 50
                                    ...
                                    If CInt(session("admin")) = 2 Then
                                        ...
                                        End If
                                    Else
                                        Response.WRITE "<TD>" & "<a HREF=delete_candidate.asp?company_id=" & rs("company_id") & "&id=" & rs("id") & ">" & "Delete ID:" & rs("id") & "</TD>"
                                    End If
                                    Response.Write "</TR>"
                                ...
                                Response.Write "</TABLE></font></CENTER>" 
                            end if
                            rs.close
                            set rs = nothing
                            conn.close
