...
Partial Class ucc11
  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    Try
            Dim sUS_ID As String = EnterSearch(sDebtor1, "", sSR, "", sCR, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, sRec1, sDate1, sType1, sRec2, sDate2, sType2, sRec3, sDate3, sType3, sRec4, sDate4, sType4, sRec5, sDate5, sType5, sRec6, sDate6, sType6, txtAdditional.Text.Replace("'", "''"), "N", Session("UserID"), Session("company_rid"), Search_Charge, us_loan_type)
    Catch ex As Exception
