<%@ Page Title="UCC - Reports" Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="reports.aspx.vb" Inherits="reports" %>
    ...
    <telerik:RadAjaxPanel ID="rapOne" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="onRequestStart">
        <table cellpadding="2" cellspacing="0" border="1" style="font-size: 8pt; width: 775px;">
          ...
          <asp:Button ID="btnSearch" runat="server" Text="Search" />
            ...
            <tr>
                <td align="center">Loan Type:
                    <asp:DropDownList ID="ddlLoanType" runat="server">
                        <asp:ListItem Value="0">Select One</asp:ListItem>
                        <asp:ListItem Value="FSLS">Farm Storage Facility Loan</asp:ListItem>
            ...
            <tr>
                <td>
                    ...
                    <telerik:RadGrid ID="rgCharge" runat="server" GridLines="None" AutoGenerateColumns="False" AllowSorting="True"
                        ...
                        <MasterTableView DataKeyNames="typ,company_id" AllowPaging="True" AllowFilteringByColumn="false" GridLines="None"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="Type" DataField="typ" Aggregate="Count" FooterText="Count: "
                                   ...
                                   <telerik:GridBoundColumn HeaderText="Charge" DataFormatString="{0:c}" Aggregate="Sum" FooterText="Total: "
								    DataField="charge" UniqueName="charge" SortExpression="charge"></telerik:GridBoundColumn>
                            </Columns>
                            <GroupByExpressions>
