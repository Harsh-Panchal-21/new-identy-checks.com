...
Partial Class admin_filing
    ...
    If Not Page.IsPostBack Then
      ...
      If dtData.Rows.Count > 0 Then
        With dtData.Rows(0)
          ...
          txtFile_No.Text = .Item("uf_file_no") & ""

          If txtFile_No.Text <> "" Then
            lblViewAttach.Text = "<a href='View_File.aspx?type=UCC1&id=" & sID & "' target='_blank'>View Confirmation</a>"
          End If
        End With
      End If
      dtData.Dispose()
  ...
  Protected Sub btnUpload_Click(sender As Object, e As System.EventArgs) Handles btnUpload.Click
    ...
    Using myConnection As New SqlConnection(CNNStr)
      ...
      Dim SQL As String = "Update ucc_financing set " & _
        "uf_file_no = @file_no, uf_file_attach = @ImageData Where uf_id = " & Request.QueryString("id")
