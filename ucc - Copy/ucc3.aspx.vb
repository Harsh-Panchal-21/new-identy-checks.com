...
Partial Class ucc3
  ...
  Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
    ...
    ElseIf chkPartyChange.Checked Then
      'chkAmend_Debtor.Checked Or chkAmend_Secured_Party.Checked Or chkAmend_Add.Checked Or chkAmend_Change.Checked Or chkAmend_Delete.Checked
      'amendment
    ...
    Try
      ...
      '"'Address','City','ST','Zip','Country'," & _
            sSQL = "Insert Into ucc3 (u3_uf_id,u3_initial_file_no,u3_real_estate,u3_loan_type,u3_termination,u3_continuation,u3_assignment,u3_amendment_affects," & _
        ...
        Try
          ...
          If chkDebtor3_RunSearch.Checked Then
            ...
            Dim sMoreOther As String = txtMoreOther3.Text
                        Dim sUS_ID As String = EnterSearch(sDebtor3, "", sSR3, "", sCR3, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional3.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue)
          End If
        Catch ex As Exception
        ...
        Try
          ...
          If chkDebtor4_RunSearch.Checked Then
            ...
            Dim sMoreOther As String = txtMoreOther4.Text
                        Dim sUS_ID As String = EnterSearch(sDebtor4, "", sSR4, "", sCR4, "", sMoreDate, sMoreAddress, sMoreName, sMoreOther, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", txtAdditional4.Text, "N", Session("UserID"), Session("company_rid"), Search_Charge_with_File, ddlLoanType.SelectedValue)
          End If
        Catch ex As Exception
